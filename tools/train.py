...
def parse_args():
    ...
    parser.add_argument('--work-dir', default="/media/hasiegf/data/mmdet3d/out/carla/waveform/model/supervised/semipretrained/epoch1/no_threshold/filtered", help='the dir to save logs and models')
    parser.add_argument(
        '--amp',
        action='store_true',
        default=False,
